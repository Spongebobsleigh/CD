...
class PopeDataset(BaseEvalDataset):
    ...
    def _evaluate(self, model, result_file_manager):
        ...
        tracked_categories = ["adversarial", "popular", "random"]
        metrics = {cat: {"TP": 0, "TN": 0, "FP": 0, "FN": 0, "yes_count": 0, "no_count": 0} for cat in tracked_categories}
        metrics["overall"] = {"TP": 0, "TN": 0, "FP": 0, "FN": 0, "yes_count": 0, "no_count": 0}
