...
if __name__ == '__main__':
    ...
    parser.add_argument('--response', type=str, default='benchmarks/mmhalbench/idefics_80b.json', help='response file containing images, questions, and model responses')
    ...
    for i, response in enumerate(responses):
        ...
        scores_found = []
        for s in range(7):
            if f'rating: {s}' in response.lower() or f'Rating: {s}' in response:
