...
if __name__ == "__main__":
    ...
    args.add_argument(
        "--method",
        action="store_true",
        help="Use the alternative contrastive decoding method defined in cd_method.py (requires --contrastive).",
        default=False,
    )
