...
class BaseModel(ABC):
    def __init__(self, model_name: str, model_path: str, *, max_batch_size: int = 1, contrastive: bool = False, alt_text: bool = False,  excel: bool = False, opera_decoding = False, vcd_decoding = False, cd_alpha = None, use_simple_diff: bool = False):
        ...
        self.use_simple_diff = use_simple_diff
        if self.alt_text:
            picd_greedy()
            picd_search()
            picd_sampling()
